/**
 * Page Analyzer Feature - Simple Tab Component (Page Size Only)
 * Analyzes basic page size information with built-in action result display
 * @module @voilajsx/comet
 * @file src/features/page-analyzer/components/PageAnalyzerTab.tsx
 */
...
export default function PageAnalyzerTab({ value, currentTab }: PageAnalyzerTabProps) {
  ...
  const [analyzerResult, setAnalyzerResult] = useState<ActionResultType | null>(null);
  const [pageSizeData, setPageSizeData] = useState<PageSizeData | null>(null);
  ...
  const handleAnalyzePage = async () => {
    ...
    try {
      ...
      if (response?.success) {
        ...
        setAnalyzerResult({
          type: 'success',
          message: 'Page size analyzed successfully!'
        });
      } else {
        setAnalyzerResult({
          type: 'error',
